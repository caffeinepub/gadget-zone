          ...
          >
            {mobileOpen ? (
              <>
                ...
                <span className="text-[9px] font-bold tracking-widest text-foreground leading-none">CLOSE</span>
              </>
            ) : (
              <>
                <Menu className="w-5 h-5 text-foreground" />
                <span className="text-[9px] font-bold tracking-widest text-foreground leading-none">MENU</span>
              </>
            )}
          </button>
        </div>
      ...
      {mobileOpen && (
        <div className="lg:hidden border-t border-border bg-white shadow-lg">
          <nav className="container mx-auto px-4 py-3 flex flex-col gap-1" aria-label="Mobile navigation">
            ...
            <a
              href={PHONE}
              onClick={() => { trackCallConversion(); setMobileOpen(false); }}
