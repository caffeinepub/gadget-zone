            ...
            if (item.href) {
              return (
                <a
                  ...
                  data-ga-context={(item as { gaContext?: string }).gaContext || undefined}
                  data-ga-label={(item as { gaLabel?: string }).gaLabel || undefined}
                  onClick={(item as { onClickFn?: () => void }).onClickFn || undefined}
                >
                  {content}
                </a>
              );
