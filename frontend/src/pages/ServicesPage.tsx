...
import { Phone, MessageCircle, ArrowRight, Wrench, Smartphone, RefreshCw, Package, Camera, CreditCard } from 'lucide-react';
...
const SERVICES = [
  {
    ...
    features: ['Genuine products with manufacturer warranty', 'All major brands in stock', 'EMI options available', 'Expert guidance to choose the right phone'],
    cta: 'Enquire Now',
    whatsapp: 'Hi, I am interested in buying a new mobile phone. Please share available models and prices.',
    path: '/products',
  },
  {
    id: 'service-repair',
    ...
    features: ['Screen & display replacement', 'Battery replacement', 'Charging port & speaker repair', 'Water damage recovery', 'Software issues & unlocking'],
    cta: 'Book Repair',
  ...
  },
  {
    ...
    features: ['Best exchange value guaranteed', 'Instant valuation', 'All brands accepted', 'Upgrade to any new model'],
    cta: 'Get Exchange Value',
    whatsapp: 'Hi, I want to exchange my old phone. Please help me with the exchange value.',
  ...
  },
  {
    ...
    features: ['Genuine branded accessories', 'Cases & screen protectors', 'Chargers & cables', 'Earphones & Bluetooth devices', 'Smartwatches & fitness bands'],
    cta: 'Shop Accessories',
    whatsapp: 'Hi, I am looking for mobile accessories. Please share what is available.',
  ...
  },
  {
    ...
    features: ['HD & 4K camera systems', 'Home & shop security', 'Professional installation', 'Remote monitoring setup', 'Annual maintenance contracts'],
    cta: 'Get CCTV Quote',
    whatsapp: 'Hi, I am interested in CCTV installation. Please share details and pricing.',
    path: '/services/cctv',
  },
  {
    id: 'emi-finance',
    ...
    features: ['0% EMI on select models', 'Flexible tenure options', 'Minimal documentation', 'Quick approval process', 'All major banks supported'],
...
export default function ServicesPage({ onNavigate }: ServicesPageProps) {
  useEffect(() => {
    updateSEO({
      title: 'Services – Mobile Repair, Exchange, CCTV & More | Gadget Zone Chennai',
      description:
    ...
    <main className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-primary/10 to-secondary/10 py-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-4">Our Services</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            From buying a new phone to repairing your existing one – Gadget Zone is your one-stop destination in Thiruvanmiyur, Chennai.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button
              size="lg"
              variant="secondary"
              onClick={() => handleWhatsApp('Hi, I need help choosing a service at Gadget Zone.')}
            >
