...
import { trackContactFormConversion, trackWhatsAppConversion, trackCallConversion } from '@/lib/googleAdsTracking';
      ...
      <section className="bg-gradient-to-br from-primary/10 to-secondary/10 py-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            We're here to help. Reach out via call, WhatsApp, or visit us in Thiruvanmiyur, Chennai.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="flex items-start gap-4 p-4 bg-card rounded-xl border border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      73 KALKI, Lattice Bridge Road (LB ROAD),<br />
                      KRISHNAMURTHY SALAI, Thiruvanmiyur,<br />
            ...
            <div>
              ...
              <div className="mt-8 pt-6 border-t border-border">
                <p className="text-sm font-semibold text-foreground mb-3">Or contact us directly:</p>
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button asChild className="flex-1 bg-green-600 hover:bg-green-700 text-white border-0">
                    <a
                      href={`https://wa.me/${WHATSAPP_NUMBER}`}
                      target="_blank"
                      rel="noopener noreferrer"
