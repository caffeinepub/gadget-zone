...
import { Phone, MessageCircle, CheckCircle, ArrowLeft, Star, Shield, Award, Users, Wrench, CreditCard } from 'lucide-react';
...
const WA_MSG = "Hi! I'd like to know more about Gadget Zone Chennai and your services.";
  ...
  const advantages = [
    {
      ...
      points: ['Official brand authorization', 'Manufacturer warranty on all devices', 'Genuine products guaranteed', 'Brand-certified service'],
    },
    {
      icon: Shield,
      ...
      points: ['100% genuine products', 'Sourced from authorized distributors', 'Authenticity verification', 'No grey market products'],
    },
    {
      icon: Wrench,
      ...
      points: ['Certified technicians', 'Genuine spare parts', '90-day repair warranty', 'Same-day service available'],
    },
    {
      icon: Star,
      ...
      points: ['Best price guarantee', 'Transparent pricing', 'No hidden charges', 'Price match available'],
    },
    {
      icon: CreditCard,
      ...
      points: ['Zero-cost EMI available', 'All major banks supported', 'Instant approval', 'Flexible tenure options'],
    },
    {
      icon: Users,
      ...
      points: ['After-sales support', 'Warranty assistance', 'Customer-first approach', 'Thousands of happy customers'],
    },
  ];
    ...
    <main className="min-h-screen">
      <section className="bg-gradient-to-br from-primary/10 to-secondary/10 py-16 px-4">
        <div className="container mx-auto max-w-5xl">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-4">Why Choose Gadget Zone?</h1>
          <p className="text-lg text-muted-foreground max-w-2xl">
            Thousands of customers across Chennai trust Gadget Zone for their smartphone needs.
      ...
      <div className="container mx-auto max-w-5xl px-4 py-16 space-y-16">
        {/* Advantages */}
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4">Our Key Advantages</h2>
          <p className="text-muted-foreground mb-8">
            We've built our reputation on trust, quality, and exceptional service. Here are the
            reasons why Gadget Zone is Chennai's preferred mobile phone destination.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {advantages.map((adv) => {
              const Icon = adv.icon;
              return (
                <div key={adv.title} className="bg-card rounded-xl p-6 border border-border shadow-sm">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">{adv.desc}</p>
        ...
        {/* Service Area */}
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4">Serving All of South Chennai</h2>
          <p className="text-muted-foreground mb-6">
            Conveniently located at Thiruvanmiyur, we serve customers from across South Chennai.
            Our central location makes us easily accessible from all nearby areas.
          </p>
          <div className="flex flex-wrap gap-3">
            {['Thiruvanmiyur', 'Adyar', 'Besant Nagar', 'Thoraipakkam', 'Velachery', 'Perungudi', 'OMR', 'ECR', 'Sholinganallur', 'Pallikaranai'].map((area) => (
              <span key={area} className="px-4 py-2 bg-card border border-border rounded-full text-sm font-medium text-foreground">
                {area}
              </span>
            ))}
          </div>
        ...
        <section className="bg-card rounded-2xl p-8 border border-border text-center">
          <h2 className="text-2xl font-bold text-foreground mb-3">Experience the Gadget Zone Difference</h2>
          <p className="text-muted-foreground mb-6">
            Visit us today at 73 KALKI, Lattice Bridge Road, Thiruvanmiyur, Chennai — or reach out
            to us via call or WhatsApp. We're open 7 days a week, 10 AM to 9 PM.
          </p>
