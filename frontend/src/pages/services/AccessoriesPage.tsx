...
import { Phone, MessageCircle, CheckCircle, ArrowLeft, Package } from 'lucide-react';
...
const WA_MSG = "Hi! I'm looking for mobile accessories at Gadget Zone Chennai. Please share what's available.";
  ...
  const categories = [
    {
      ...
      items: ['Transparent cases', 'Leather flip covers', 'Rugged armor cases', 'Designer back covers', 'Wallet cases'],
    },
    {
      title: 'Screen Protectors',
      desc: 'Keep your display scratch-free with tempered glass and film screen protectors for all models.',
      items: ['Tempered glass', 'Full-cover glass', 'Privacy glass', 'Anti-glare film', 'Curved glass'],
    },
    {
      title: 'Chargers & Cables',
      desc: 'Fast chargers, wireless chargers, and high-quality cables for all devices.',
      items: ['Fast chargers (65W, 120W)', 'Wireless chargers', 'USB-C cables', 'Lightning cables', 'Multi-port chargers'],
    },
    {
      title: 'Power Banks',
      desc: 'Never run out of battery with our range of power banks from 10,000mAh to 30,000mAh.',
      items: ['10,000mAh power banks', '20,000mAh power banks', 'Fast-charge power banks', 'Slim power banks', 'Solar power banks'],
    },
    {
      title: 'Earphones & Headphones',
      desc: 'Wired and wireless audio accessories for music lovers and professionals.',
      items: ['TWS earbuds', 'Wired earphones', 'Over-ear headphones', 'Neckband earphones', 'Gaming headsets'],
    },
    {
      title: 'Bluetooth Speakers',
      desc: 'Portable and home Bluetooth speakers for every occasion and budget.',
      items: ['Portable speakers', 'Waterproof speakers', 'Party speakers', 'Smart speakers', 'Mini speakers'],
    },
  ];
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                Wide range of genuine mobile accessories at Gadget Zone Chennai. Cases, chargers,
                earphones, power banks, and more — all at competitive prices.
              </p>
            </div>
          </div>
      ...
      <div className="container mx-auto max-w-5xl px-4 py-16 space-y-16">
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4">Our Accessories Range</h2>
          <p className="text-muted-foreground mb-6">
            We stock accessories for all major smartphone brands. All products are genuine and
            sourced from authorized distributors, ensuring quality and compatibility.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((cat) => (
              <div key={cat.title} className="bg-card rounded-xl p-6 border border-border shadow-sm">
        ...
        <section className="bg-card rounded-2xl p-8 border border-border">
          <h2 className="text-2xl font-bold text-foreground mb-4">Why Buy Accessories from Gadget Zone?</h2>
