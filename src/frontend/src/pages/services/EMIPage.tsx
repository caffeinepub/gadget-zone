...
const WA_MSG =
  "Hi! I'd like to know about EMI and finance options for buying a smartphone at Gadget Zone Chennai.";
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                Make your dream smartphone affordable with flexible EMI options
                at Gadget Zone Chennai. Zero-cost EMI, instant approval, and
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            ...
            >
              <a
                ...
                data-ga-context="emi_page"
              >
                <MessageCircle className="w-4 h-4 mr-2" /> WhatsApp for EMI
                Details
              </a>
            </Button>
          </div>
      ...
      <div className="container mx-auto max-w-5xl px-4 py-16 space-y-16">
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-6">
            We offer multiple EMI options to suit your financial needs. Whether
            you prefer zero-cost EMI on your credit card or a bank finance
            option, we have a solution for you.
          </p>
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-6">
            Getting EMI approval is quick and easy. Here's what you typically
            need to get started:
          </p>
            ...
            {[
              {
                ...
                desc: "Must be 21 years or older to apply for finance options.",
              },
              {
                title: "Identity Proof",
                desc: "Aadhaar card, PAN card, or passport for identity verification.",
              },
              {
                title: "Income Proof",
                desc: "Salary slip or bank statement for bank finance options.",
              },
              {
                title: "Credit Card",
                desc: "Any major credit card for zero-cost or credit card EMI options.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-6">
            We work with leading banks and financial institutions to offer you
            the best EMI options with competitive interest rates and flexible
            tenure.
          </p>
        ...
        <section className="bg-card rounded-2xl p-8 border border-border">
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Get Your Dream Phone on EMI Today
          </h2>
