...
const WA_MSG =
  "Hi! I'd like to know about the mobile exchange and upgrade offers at Gadget Zone Chennai.";
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                Get the best value for your old smartphone and upgrade to the
                latest model at Gadget Zone Chennai. Instant valuation,
                transparent pricing, and seamless exchange.
              </p>
            </div>
          </div>
          <div className="flex flex-wrap gap-3 mt-8">
            <Button asChild size="lg">
              ...
              >
                <Phone className="w-4 h-4 mr-2" /> Get Exchange Value:{" "}
                {PHONE_DISPLAY}
              </a>
            </Button>
            <Button
            ...
            >
              <a
                ...
                data-ga-context="exchange_page"
              >
                <MessageCircle className="w-4 h-4 mr-2" /> WhatsApp for
                Valuation
              </a>
            </Button>
          </div>
      ...
      <div className="container mx-auto max-w-5xl px-4 py-16 space-y-16">
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-6">
            Our exchange process is simple, transparent, and hassle-free. We
            accept all brands and conditions, and offer the best market value
            for your old device.
          </p>
            ...
            {[
              {
                ...
                desc: "Visit our store with your old smartphone and original accessories.",
              },
              {
                step: "2",
                title: "Free Evaluation",
                desc: "Our experts assess your device condition and provide an instant valuation.",
              },
              {
                step: "3",
                title: "Get Best Price",
                desc: "We offer the best market price for your old device — no hidden deductions.",
              },
              {
                step: "4",
                title: "Upgrade & Go",
                desc: "Apply the exchange value to your new phone purchase and walk out happy.",
              },
            ].map((item) => (
              <div
                key={item.step}
        ...
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4">
            What Affects Your Exchange Value?
          </h2>
          <p className="text-muted-foreground mb-6">
            We evaluate your device based on several factors to give you the
            most accurate and fair valuation. Here's what we consider:
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              {
                factor: "Device Condition",
                desc: "Screen condition, body scratches, and overall physical state of the device.",
              },
              {
                factor: "Age of Device",
                desc: "Newer devices generally fetch higher exchange values.",
              },
              {
                factor: "Brand & Model",
                desc: "Premium brands like Apple and Samsung typically have higher resale values.",
              },
              {
                factor: "Functionality",
                desc: "All features working properly increases the exchange value significantly.",
              },
              {
                factor: "Original Accessories",
                desc: "Having original box, charger, and earphones can increase the value.",
              },
              {
                factor: "Storage Capacity",
                desc: "Higher storage variants command better exchange prices.",
              },
            ].map((item) => (
              <div
                key={item.factor}
        ...
        <section className="bg-card rounded-2xl p-8 border border-border">
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Exchange Benefits at Gadget Zone
          </h2>
