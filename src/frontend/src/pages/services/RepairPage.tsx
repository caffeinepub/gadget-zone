...
const WA_MSG =
  "Hi! I need to book a mobile repair service at Gadget Zone Chennai. Can you help?";
  ...
  const repairServices = [
    {
      ...
      desc: "Cracked or broken display? We replace screens for all brands with genuine parts.",
      time: "1–2 hours",
    },
    {
      name: "Battery Replacement",
      desc: "Poor battery life or swollen battery? Get a genuine replacement battery installed.",
      time: "30–60 mins",
    },
    {
      name: "Charging Port Repair",
      desc: "Phone not charging? We fix or replace charging ports for all models.",
      time: "1–2 hours",
    },
    {
      name: "Water Damage Recovery",
      desc: "Dropped your phone in water? Our technicians can recover water-damaged devices.",
      time: "24–48 hours",
    },
    {
      name: "Software Issues",
      desc: "Phone stuck, slow, or not booting? We fix software problems and restore your data.",
      time: "1–3 hours",
    },
    {
      name: "Speaker & Mic Repair",
      desc: "Can't hear calls or people can't hear you? We repair speakers and microphones.",
      time: "1–2 hours",
    },
    {
      name: "Camera Repair",
      desc: "Blurry photos or camera not working? We fix front and rear camera issues.",
      time: "1–2 hours",
    },
    {
      name: "Back Glass Replacement",
      desc: "Cracked back glass? We replace back panels for premium smartphones.",
      time: "2–3 hours",
    },
  ];
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                Expert repair for all smartphone brands in Chennai. Genuine
                parts, certified technicians, and 90-day warranty on all repairs
                at Gadget Zone Thiruvanmiyur.
              </p>
            </div>
          </div>
      ...
      <div className="container mx-auto max-w-5xl px-4 py-16 space-y-16">
          ...
          {[
            {
              ...
              desc: "Most repairs completed within 2–4 hours",
            },
            {
              icon: Shield,
              title: "90-Day Warranty",
              desc: "All repairs backed by our service warranty",
            },
            {
              icon: CheckCircle,
              title: "Genuine Parts",
              desc: "Only original or OEM-quality parts used",
            },
          ].map((item) => {
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-6">
            We repair all major smartphone brands including Apple, Samsung,
            OnePlus, Motorola, Realme, Vivo, Xiaomi, and more. Our certified
            technicians use genuine parts to ensure your device works like new.
          </p>
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-6">
            Our technicians are trained to repair all major smartphone brands.
            Whether you have an iPhone, Samsung Galaxy, OnePlus, or any other
            brand, we have the expertise and parts to fix it.
          </p>
        ...
        <section className="bg-card rounded-2xl p-8 border border-border">
          ...
          <p className="text-muted-foreground mb-6">
            Don't let a broken phone slow you down. Visit us at Gadget Zone,
            Thiruvanmiyur, or contact us to book your repair appointment. We
            offer free diagnosis for all devices.
          </p>
