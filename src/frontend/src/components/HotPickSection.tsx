    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-base md:text-lg text-neutral-400 mb-12 max-w-3xl mx-auto">
          This premium Motorola Signature smartphone is our top pick this month
          for its exceptional value, powerful performance, and clean Android
          experience. Customers love it for reliability and style.
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-2 lg:order-2 space-y-6 text-white">
            ...
            <div className="space-y-4 text-neutral-300 text-base leading-relaxed">
              <p>
                Experience premium design, powerful performance, and a clean
                Android experience with the latest Motorola Signature
                smartphone.
              </p>
              <p>
                Available now at Gadget Zone – your trusted local mobile store
                serving Thiruvanmiyur, Adyar, Besant Nagar, Thoraipakkam,
                Velachery, Perungudi, and nearby areas along OMR and ECR in
                Chennai.
              </p>
            </div>
